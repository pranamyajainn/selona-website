  ...
  return (
    <footer className="gutter bg-mist pt-20 pb-28 md:pb-10">
      <div className="mx-auto flex max-w-6xl flex-col gap-14">
              ...
              <ul className="flex flex-col gap-2.5">
                {col.links.map((l) => (
                  <li key={l.label}>
                    <Link
                      href={l.href}
                      className="type-body text-ink transition-colors duration-200 hover:text-sky"
                    >
                      {l.label}
                    </Link>
                  </li>
        ...
        <div className="flex flex-col gap-3 text-sm text-body-60 md:flex-row md:items-center md:justify-between">
          <p>Selona. AI automation for business processes.</p>
          <div className="flex gap-6">
            <Link href="/privacy" className="hover:text-sky">
              Privacy
            </Link>
            <Link href="/changelog" className="hover:text-sky">
              Updates
            </Link>
          </div>
        </div>
